...
import com.dcc025.view.TelaCadastroPaciente;
...
public class SalvarPaciente implements ActionListener{
    
    private TelaCadastroPaciente tela;
    ...
    public SalvarPaciente(TelaCadastroPaciente tela, Medico medico) {
        this.tela = tela;
    ...
    public SalvarPaciente(TelaCadastroPaciente tela, Usuario secretaria) {
        this.tela = tela;
        this.formato = new SimpleDateFormat("dd/MM/yyyy");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            this.paciente = new Paciente(quest,
        ...
        Controller.getPacientes().add(paciente);
